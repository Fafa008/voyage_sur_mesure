  ...
  return (
    <Card className="border-blue-200/60 bg-blue-500/5">
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Veuillez effectuer le virement de{" "}
          <strong className="text-foreground">{amount} MGA</strong> en indiquant
          impérativement la référence ci-dessous.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-5">
        <div className="space-y-3 bg-card p-4 rounded-xl border border-border/80 text-sm">
          ...
          <div className="flex items-center justify-between py-1.5 bg-blue-500/10 p-2.5 rounded-lg border border-blue-500/20">
            <span className="text-blue-700 dark:text-blue-300 font-bold text-xs uppercase tracking-wider">
              Référence obligatoire
            </span>
            <div className="flex items-center gap-2">
              <span className="font-mono font-extrabold text-blue-800 dark:text-blue-200">
                {ref}
              </span>
              <button
                type="button"
        ...
        <div className="flex items-start gap-2.5 text-xs text-muted-foreground bg-muted/40 p-3 rounded-xl border border-border/40">
          ...
          <p>
            Votre réservation est actuellement enregistrée en attente de
            paiement. Dès réception de votre virement (généralement 24-48h),
            votre conseiller validera définitivement votre voyage.
          </p>
        </div>
