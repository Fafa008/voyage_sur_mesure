  ...
  return (
    <div className={cn("relative inline-block text-left", className)} ref={dropdownRef}>
      <button
        ...
        aria-label={`Changer la devise d'affichage (actuelle : ${currentConfig.name})`}
        className={cn(
      ...
      {isOpen && (
        <div
          ...
          className="absolute right-0 z-50 mt-1.5 w-52 rounded-xl border border-border bg-popover p-1.5 text-popover-foreground shadow-xl animate-in fade-in-0 zoom-in-95"
        >
