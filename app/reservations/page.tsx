    ...
    <main className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          Retrouvez l'historique de vos voyages confirmés et leurs détails de paiement.
        </p>
      </div>
      ...
      {reservations.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {reservations.map((res) => (
            <Card key={res.id} className="border border-border/60 hover:border-primary/30 transition-colors">
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <Badge className={`shrink-0 border ${statutColors[res.statut]}`}>
